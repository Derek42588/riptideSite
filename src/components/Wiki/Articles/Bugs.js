    ...
    return (
        <div className = "wiki__content-box__article wiki__content-box__article--bugs">
            ...
            <ul className="wiki__content-box__article__info__list wiki__content-box__article__info__list--bugs">
                ...
                <li className="wiki__content-box__article__info__list__item wiki__content-box__article__info__list__item--bugs--2">Quest Timers currently off, will be fixed next reset</li>
